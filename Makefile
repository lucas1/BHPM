# This Makefile is for the BHPM extension to perl.
#
...
#     NAME => q[BHPM]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Dancer2=>q[0.1] }
#     VERSION_FROM => q[lib/BHPM.pm]
#     clean => { FILES=>q[BHPM-*] }
...
TO_INST_PM = lib/BHPM.pm

PM_TO_BLIB = lib/BHPM.pm \
	blib/lib/BHPM.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               BHPM' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Dancer2:     0.1' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer2::" VERSION="0.1" />' >> $(DISTNAME).ppd
